...
exports.getTopExercises = exports.getDashboardActivity = exports.getDashboardData = exports.getExerciseData = void 0;
const Set_1 = __importDefault(require("../models/Set"));
const errorResponse_1 = require("../utils/errorResponse");
const getExerciseData = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const query = [];
    try {
...
const getDashboardData = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const sets = yield Set_1.default.find({
            ...
            .populate("exercise");
        if (sets.length === 0) {
            return next(new errorResponse_1.ErrorResponse("No sets found", 404));
        }
        // Compute total sets
        const completedSets = {
            title: "Sets",
        ...
        const maxExercise = Object.keys(distinctExercises).reduce((a, b) => distinctExercises[a] > distinctExercises[b] ? a : b);
        const topExercise = {
            title: "Top Exercise",
        ...
        const maxArea = Object.keys(distinctAreas).reduce((a, b) => distinctAreas[a] > distinctAreas[b] ? a : b);
        const topArea = {
            title: "Top Area",
            subtitle: maxArea,
        ...
        const maxWorkout = Object.keys(repsByWorkout).reduce((a, b) => repsByWorkout[a] > repsByWorkout[b] ? a : b);
        const bestWorkout = {
            title: "Best Workout",
            subtitle: "Repetitions",
...
const getDashboardActivity = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { range } = req.query;
    try {
        const user = req.user;
        const currDate = new Date();
        const startDate = new Date(new Date().setDate(currDate.getDate() - dateRange[range]));
        // Get all user sets
        const sets = yield Set_1.default.find({
            user: user._id,
            date: {
...
const getTopExercises = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const exerciseStats = sets.reduce((acc, set) => {
            ...
            if (acc[set.exercise.name]) {
                ...
                acc[set.exercise.name].avgReps = (acc[set.exercise.name].repCount / acc[set.exercise.name].setCount).toFixed(1);
