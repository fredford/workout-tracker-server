...
const error_js_1 = __importDefault(require("./middleware/error.ts"));
...
const connectDB = () => __awaiter(void 0, void 0, void 0, function* () {
  const mongooseDb = yield mongoose_1.default.connect(process.env.WORKOUTTRACKER_DB_URI, {
  ...
  const adminJSrouter = express_2.default.buildAuthenticatedRouter(adminJs, {
    authenticate: (email, password) => __awaiter(void 0, void 0, void 0, function* () {
      if (email === "admin@admin.com") {
        const user = yield User_1.default.findOne({email: "admin@admin.com"}).select("+password");
